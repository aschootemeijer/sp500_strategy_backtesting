...
This framework allows the user to investigate the effectiveness of different trading strategies in comparison to a control group (random stocks from the S&P500).
...
- data_loader.py: Automated data ingestion via Yahoo Finance API with full split and dividend (total return) adjustments.
